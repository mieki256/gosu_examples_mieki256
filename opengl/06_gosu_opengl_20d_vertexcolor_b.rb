...
# Last updated: <2023/10/15 09:49:49 +0900>
#
...
EOS
  ...
  def exec_gl
    ...
    unless $glbind
      ...
      # opengl-bindings
      glBindBuffer(GL_ARRAY_BUFFER, @buffers.unpack('L')[0])
      glVertexAttribPointer(@coord2d, 2, GL_FLOAT, GL_FALSE, 5 * nf, 0)
      glVertexAttribPointer(@v_color, 3, GL_FLOAT, GL_FALSE, 5 * nf, 2 * nf)
    end
